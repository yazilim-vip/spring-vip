 ...
 */
abstract class AGenericRestCrud<E : Any, ID : Any>(restResponseBuilder: IRestResponseBuilder, genericServiceCrud: IGenericServiceCrud<E, ID>, classOfEntity: KClass<E>) : AGenericRestWrite<E, ID>(restResponseBuilder, genericServiceCrud, classOfEntity) {
