 ...
 */
abstract class AGenericRestCrud<E : Any, ID : Any>(springVipHttpRestConfig: SpringVipHttpRestConfig, crudService: ICrudService<E, ID>, classOfEntity: KClass<E>) : AGenericRestCru<E, ID>(springVipHttpRestConfig, crudService, classOfEntity) {
