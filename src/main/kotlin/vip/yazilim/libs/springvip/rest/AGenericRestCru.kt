 ...
 */
abstract class AGenericRestCru<E : Any, ID : Any>(springVipHttpRestConfig: SpringVipHttpRestConfig, crudService: ICrudService<E, ID>, classOfEntity: KClass<E>) : AGenericRestRead<E, ID>(springVipHttpRestConfig, crudService, classOfEntity) {
