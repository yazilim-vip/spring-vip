 ...
 */
abstract class AGenericRestCru<E : Any, ID : Any>(restResponseBuilder: IRestResponseBuilder, crudService: ICrudService<E, ID>, classOfEntity: KClass<E>) : AGenericRestRead<E, ID>(restResponseBuilder, crudService, classOfEntity) {
